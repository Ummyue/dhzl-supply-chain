...
const MockData = {
  ...
  admissionList: [
    ...
    // ----- 已通过（办结：5 步全走完）-----
    {
      ...
      status: 'approved',  // v1.7.38: 5 步数据已补全，状态置为 approved
      currentApprover: null,
      progress: 5,
      totalSteps: 5,
    ...
    // ----- v1.7.38 新增办结示例：青岛海盈国际冷链有限公司 -----
    {
      id: 'adm_007',
      customer: '青岛海盈国际冷链有限公司',
      creditCode: '91370200MAXXXXXXXX',
      legalRep: '林志鸿',
      registeredCap: '8000万元',
      established: '2017-03-25',
      bizScope: '国际海运冷链运输；进口冻品仓储与分拨',
      ...
      attachments: ['营业执照.pdf', '审计报告-毕马威.pdf', 'AEO高级认证.pdf', 'GMP+认证.pdf'],
      drafter: '陈志强',
      sealUser: '李雪',
      sealCompleted: true,
    },
    // ----- v1.7.40 新增现场考察示例：上海冰港国际物流有限公司 -----
    {
      id: 'adm_008',
      customer: '上海冰港国际物流有限公司',
      creditCode: '91310000MAXXXXXXXX',
      legalRep: '王晓东',
      registeredCap: '5000万元',
      established: '2014-09-12',
      bizScope: '国际冷链物流；冷库仓储；进口清关',
      applyDate: '2026-07-08',
      status: 'reviewing',
      currentApprover: 'platform',
      progress: 3,
      totalSteps: 5,
      attachments: ['营业执照.pdf', '财务报表2024.pdf', '完税证明.pdf', 'ISO22000.pdf'],
      drafter: '陈志强',
      sealUser: '李雪',
      sealCompleted: true,
    },
    // ----- v1.7.40 新增风险评估示例：浙江舟山远洋渔业股份有限公司 -----
    {
      id: 'adm_009',
      customer: '浙江舟山远洋渔业股份有限公司',
      creditCode: '91330900MAXXXXXXXX',
      legalRep: '陈大海',
      registeredCap: '1.2亿元',
      established: '2010-06-18',
      bizScope: '远洋捕捞；海产品冷链；进出口贸易',
      applyDate: '2026-07-10',
      status: 'reviewing',
      currentApprover: 'platform',
      progress: 4,
      totalSteps: 5,
      attachments: ['营业执照.pdf', '远洋渔业许可证.pdf', 'MSC认证.pdf', '审计报告2024.pdf'],
      drafter: '陈志强',
      sealUser: '李雪',
      sealCompleted: true,
    },
    // ----- v1.7.40 新增不通过示例（不同驳回原因）：武汉冷链速运有限公司 -----
    {
      id: 'adm_010',
      customer: '武汉冷链速运有限公司',
      creditCode: '91420100MAXXXXXXXX',
      legalRep: '刘海涛',
      registeredCap: '500万元',
      ...
      progress: 4,
      totalSteps: 5,
      attachments: ['营业执照.pdf', '车辆行驶证.pdf'],
      drafter: '陈志强',
      sealUser: '李雪',
      sealCompleted: true,
      rejectReason: '实际控制人近 3 年有失信被执行人记录（2 起），且注册资本 500 万元低于准入门槛（建议 ≥ 1000 万元）',
    },
  ],
  ...
  admissionDetail: {
    ...
    // ========== v1.7.38 补全办结状态详情数据 ==========
    // adm_002: 河南某冷链股份有限公司 — 演示「卡在第 2 步资质审核」
    adm_002: {
      companyName: '河南某冷链股份有限公司',
      creditCode: '91410100MAXXXXXXXX',
      shortName: '豫冷股份',
      shortNamePinyin: 'YLG',
      established: '2015-08-22',
      nature: '股份有限公司',
      businessDeadline: '长期有效',
      registeredAddress: '河南省郑州市金水区国基路 168 号',
      industry: '冷链物流',
      registeredCapital: '1亿元',
      inRenewal: false,
      contactPhone: '139 0000 2345',
      contactAddress: '河南省郑州市金水区国基路 168 号',
      businessScope: '冷链仓储、冻品贸易、国际货运代理、供应链金融服务。',
      legalName: '韩志远',
      legalIdCard: '11000019750815XXXX',
      legalPhone: '139 0000 2345',
      legalIdValidFrom: '2018-03-10',
      legalIdValidTo: '2038-03-10',
      shareholders: [
        { name: '韩志远（自然人）',   type: '现金',     amount: 60000000, ratio: 60, date: '2015-08-22' },
        { name: '国信投资管理有限公司', type: '现金',     amount: 25000000, ratio: 25, date: '2015-09-15' },
        { name: '万邦物流合伙企业',     type: '股权出资', amount: 15000000, ratio: 15, date: '2016-02-20' },
      ],
      otherInfo: {
        history: '公司前身为「郑州冷链储运公司」（2008 年成立），2015 年改制为股份有限公司，2018 年完成 A 轮融资，2021 年新三板挂牌（代码：870123）。',
        relatedEnterprises: '关联企业：国信投资管理有限公司（持股 25% 股东）；万邦物流合伙企业（联营，持股 15% 股东）。',
      },
      attachments: [
        { type: '营业执照',                  required: true,  files: [{ name: '营业执照-2024年.pdf', time: '2024-05-20 10:12:33' }] },
        { type: '法人身份证复印件',          required: true,  files: [{ name: '法人身份证-韩志远.pdf', time: '2024-05-20 10:15:22' }] },
        { type: '最近一年财务报表',          required: false, files: [{ name: '2024年度财务报表.pdf', time: '2024-05-20 10:18:45' }, { name: '审计报告2024.pdf', time: '2024-05-20 10:20:11' }] },
        { type: '完税证明',                  required: false, files: [{ name: '2024年完税证明.pdf', time: '2024-05-20 10:23:08' }] },
        { type: '三个月内1-2份业务购销合同复印件、发票复印件', required: false, files: [{ name: '冷链仓储合同-2024Q4.pdf', time: '2024-05-20 10:25:30' }, { name: '国际货运代理合同.pdf', time: '2024-05-20 10:27:15' }] },
        { type: '其他附件',                  required: false, files: [{ name: '新三板挂牌材料.pdf', time: '2024-05-20 10:30:00' }] },
      ],
      legalRep: '韩志远',
      registeredCap: '1亿元',
      applyDate: '2026-07-02',
      progress: '资质审核',
      applyResult: '',
      // 第 2 步资质审核（部分填，演示"卡在审核中"）
      qualification: {
        lawsuitSituation: '公司近三年存在 2 起仓储合同纠纷诉讼（2023 年郑州万邦案件标的 120 万元 / 2024 年漯河案件标的 85 万元），均已和解结案，无执行记录。',
        businessModel: '',  // 未填写
        fundSettlement: '',  // 未填写
        balanceSheet: null,  // 暂未提供
        revenueAnalysis: null,  // 暂未提供
      },
    },

    // adm_003: 郑州某冷链贸易有限公司 — 演示「办结」（重点 5 步全有）
    adm_003: {
      companyName: '郑州某冷链贸易有限公司',
      creditCode: '91410100MAXXXXXXXX',
      shortName: '郑冷贸易',
      ...
      established: '2019-06-10',
      nature: '有限责任公司',
      businessDeadline: '至 2039-06-09',
      registeredAddress: '河南省郑州市金水区花园路 66 号建业凯旋广场 A 座 1801 室',
      industry: '冷链贸易',
      registeredCapital: '3000万元',
      inRenewal: false,
      contactPhone: '138 0000 6688',
      contactAddress: '河南省郑州市金水区花园路 66 号建业凯旋广场 A 座 1801 室',
      businessScope: '冻品批发零售；进口贸易；冷链仓储服务。',
      legalName: '陈志强',
      legalIdCard: '11000019800101XXXX',
      legalPhone: '138 0000 6688',
      legalIdValidFrom: '2020-01-01',
      legalIdValidTo: '2040-01-01',
      shareholders: [
        { name: '陈志强（自然人）',       type: '现金', amount: 21000000, ratio: 70, date: '2019-06-10' },
        { name: '李雪（自然人）',         type: '现金', amount: 6000000,  ratio: 20, date: '2019-06-10' },
        { name: '王芳（自然人）',         type: '现金', amount: 3000000,  ratio: 10, date: '2021-03-15' },
      ],
      otherInfo: {
        history: '公司由陈志强、李雪等自然人出资设立，2019 年取得食品流通许可证，2021 年获得进出口贸易资质，2023 年通过 ISO 22000 食品安全管理体系认证。',
        relatedEnterprises: '关联企业：郑州冷链物流有限公司（同一控股股东陈志强），主要承担仓储与运输职能。',
      },
      attachments: [
        { type: '营业执照',                  required: true,  files: [{ name: '营业执照-2024年.pdf', time: '2024-09-12 09:15:33' }] },
        { type: '法人身份证复印件',          required: true,  files: [{ name: '陈志强身份证.pdf', time: '2024-09-12 09:18:22' }] },
        { type: '最近一年财务报表',          required: false, files: [{ name: '2024年度财务报表.pdf', time: '2024-09-12 09:20:45' }] },
        { type: '完税证明',                  required: false, files: [{ name: '2024年完税证明.pdf', time: '2024-09-12 09:23:08' }] },
        { type: '三个月内1-2份业务购销合同复印件、发票复印件', required: false, files: [{ name: '蒙牛直采合同.pdf', time: '2024-09-12 09:25:30' }, { name: '伊利分销合同.pdf', time: '2024-09-12 09:27:15' }] },
        { type: '其他附件',                  required: false, files: [{ name: 'ISO22000证书.pdf', time: '2024-09-12 09:30:00' }] },
      ],
      legalRep: '陈志强',
      registeredCap: '3000万元',
      applyDate: '2025-11-15',
      ...
      // 第 2 步：资质审核
      qualification: {
        lawsuitSituation: '公司及关联方近三年无重大诉讼记录，2022 年 1 起货款支付纠纷已和解，无失信被执行人记录。',
        businessModel: '主营冻品批发 + 进口贸易 + 仓储服务。上游为蒙牛、伊利、新西兰银蕨等品牌供应商，下游为郑州万邦农贸批发市场及全国连锁餐饮。',
        fundSettlement: '主要采用银行电汇 + 银行承兑汇票结算，与中国银行、工商银行签订 1 年期授信合同，月均结算量约 800 万元。',
        balanceSheet: {
          periods: [
            { label: '2024 Q4', start: '2024-10', end: '2024-12' },
            { label: '2025 Q1', start: '2025-01', end: '2025-03' },
            { label: '2025 Q2', start: '2025-04', end: '2025-06' },
          ],
          rows: [
            { key: '货币资金',         items: [800,  1200, 1500] },
            { key: '应收账款',         items: [1800, 2200, 2600] },
            { key: '其他应收款',       items: [120,  150,  180] },
            { key: '预付账款',         items: [400,  500,  600] },
            { key: '存货',             items: [2200, 2500, 2800] },
            { key: '__流动资产合计',   isTotal: true, items: [5320, 6550, 7680] },
            { key: '长期股权投资',     items: [500,  500,  500] },
            { key: '固定资产净值',     items: [1800, 1750, 1700] },
            { key: '无形资产',         items: [80,   80,   80] },
            { key: '长期待摊费用',     items: [60,   50,   40] },
            { key: '__资产总计',       isTotal: true, items: [7760, 8930, 10000] },
            { key: '短期借款',         items: [600,  700,  800] },
            { key: '应付票据',         items: [300,  400,  500] },
            { key: '应付账款',         items: [1500, 1800, 2100] },
            { key: '应交税金',         items: [150,  200,  250] },
            { key: '其他应付款',       items: [100,  120,  150] },
            { key: '__流动负债合计',   isTotal: true, items: [2650, 3220, 3800] },
            { key: '__负债合计',       isTotal: true, items: [2800, 3400, 4000] },
            { key: '实收资本',         items: [3000, 3000, 3000] },
            { key: '资本公积',         items: [200,  200,  200] },
            { key: '盈余公积',         items: [150,  180,  220] },
            { key: '未分配利润',       items: [1610, 2150, 2580] },
            { key: '__所有者权益',     isTotal: true, items: [4960, 5530, 6000] },
            { key: '__负债及权益合计', isTotal: true, items: [7760, 8930, 10000] },
          ],
        },
        revenueAnalysis: {
          periods: [
          ...
          rows: [
            { key: '主营业务收入', items: [8800, 10500, 12300] },
            { key: '营业利润',     items: [880,  1050,  1230] },
            { key: '净利润',       items: [700,  840,   980] },
            { key: '销售净利率',   items: ['7.95%', '8.00%', '7.97%'] },
            { key: 'ROE',         items: ['14.1%', '15.2%', '16.3%'] },
            { key: '资产负债率',   items: ['36.1%', '38.1%', '40.0%'] },
            { key: '流动比率',     items: ['2.01',  '2.03',  '2.02'] },
            { key: '速动比率',     items: ['1.18',  '1.26',  '1.28'] },
          ],
        },
      },
      // 第 3 步：现场考察
      siteInspection: {
        situation: '现场考察时间：2025-12-05，地点：郑州市金水区花园路 66 号建业凯旋广场 A 座 1801 室。办公面积 280 平方米，固定员工 12 人，其中财务 3 人 / 销售 4 人 / 运营 5 人。仓储合作方为郑州冷链物流有限公司（关联企业），月均吞吐冻品约 1200 吨。现场管理规范，财务制度健全，无重大操作风险。',
        attachments: [
          { type: '现场考察报告',     name: '现场考察报告-2025-12-05.pdf', time: '2025-12-05 16:20:33' },
          { type: '办公场地租赁合同', name: '办公场地租赁合同.pdf',        time: '2025-12-05 16:25:11' },
        ],
      },
      // 第 4 步：风险评估
      riskAssessment: {
        complianceAnalysis: '公司及实际控制人近三年无重大违法违规记录，无失信被执行人记录，无重大税收违法记录，无重大行政处罚记录。',
        financialAnalysis: '近 3 季度财务表现稳健：营收季均增长 18-20%，净利润率稳定在 8% 左右，资产负债率 36-40%（行业合理区间），流动比率 2.0+ 偿债能力良好，速动比率 > 1.18 短期流动性充足。',
        creditEvaluation: '客户在我行及同业信用记录良好，无不良贷款记录，无重大违约事件。建议给予 A 信用评级。',
        otherNotes: '建议关注：（1）冷链贸易行业季节性波动风险；（2）进口冷链监管政策变化风险；（3）下游连锁餐饮行业景气度变化。',
        conclusion: 'pass',
        remark: '该企业资质良好，财务稳健，贸易业务规模与申报匹配，同意准入。',
      },
      // 第 5 步：办结
      completion: {
        conclusion: '通过',
        completionTime: '2025-12-15 14:30:00',
        operator: '王芳（监管方风控经理）',
        creditRating: 'A',
        suggestedLimit: '3000万元',
        nextSteps: '3 个工作日内通知客户签订授信协议；同步至融资管理模块开通融资申请权限。',
      },
    },

    // adm_006: 洛阳冷联食品贸易有限公司 — 演示「驳回到第 1 步」
    adm_006: {
      companyName: '洛阳冷联食品贸易有限公司',
      creditCode: '91410300MAXXXXXXXX',
      shortName: '洛冷联',
      shortNamePinyin: 'LLL',
      established: '2020-09-18',
      nature: '有限责任公司',
      businessDeadline: '至 2040-09-17',
      registeredAddress: '河南省洛阳市西工区凯旋路 88 号',
      industry: '冷链运输',
      registeredCapital: '800万元',
      inRenewal: false,
      contactPhone: '137 0000 5566',
      contactAddress: '河南省洛阳市西工区凯旋路 88 号',
      businessScope: '冷链运输、冻品零售。',
      legalName: '张明远',
      legalIdCard: '11000019851220XXXX',
      legalPhone: '137 0000 5566',
      legalIdValidFrom: '2019-06-15',
      legalIdValidTo: '2039-06-15',
      shareholders: [
        { name: '张明远（自然人）', type: '现金', amount: 6000000, ratio: 75, date: '2020-09-18' },
        { name: '李建伟（自然人）', type: '现金', amount: 2000000, ratio: 25, date: '2020-09-18' },
      ],
      otherInfo: {
        history: '公司由张明远、李建伟共同出资设立，2020 年取得食品流通许可证，主要服务洛阳地区餐饮连锁客户。',
        relatedEnterprises: '关联企业：洛阳明远冷链运输有限公司（同一控股股东张明远，承担运输职能）。',
      },
      attachments: [
        { type: '营业执照',                  required: true,  files: [{ name: '营业执照.pdf', time: '2024-03-12 11:20:33' }] },
        { type: '法人身份证复印件',          required: true,  files: [{ name: '张明远身份证.pdf', time: '2024-03-12 11:22:15' }] },
        { type: '最近一年财务报表',          required: false, files: [{ name: '2024年财务报表.pdf', time: '2024-03-12 11:25:08' }] },
        { type: '完税证明',                  required: false, files: [] },
        { type: '三个月内1-2份业务购销合同复印件、发票复印件', required: false, files: [{ name: '某餐饮配送合同.pdf', time: '2024-03-12 11:30:00' }] },
        { type: '其他附件',                  required: false, files: [] },
      ],
      legalRep: '张明远',
      registeredCap: '800万元',
      ...
      progress: '风险评估',
      applyResult: '不通过',
      // 第 2 步资质审核（v1.7.40 补全）
      qualification: {
        lawsuitSituation: '公司近 12 个月存在 3 起运输合同纠纷诉讼（标的合计 65 万元），2 起已判决执行，1 起仍在二审中。',
        businessModel: '主营冷链运输（长途干线 8 台车 + 城配 12 台车），客户为洛阳地区餐饮连锁与商超。',
        fundSettlement: '采用现金 + 银行转账结算，无银行授信，月均结算量约 80 万元。',
        balanceSheet: {
          periods: [
            { label: '2024 Q4', start: '2024-10', end: '2024-12' },
            { label: '2025 Q1', start: '2025-01', end: '2025-03' },
          ...
          rows: [
            { key: '货币资金',         items: [120, 180, 250] },
            { key: '应收账款',         items: [180, 220, 280] },
            { key: '其他应收款',       items: [30,  40,  50] },
            { key: '预付账款',         items: [50,  60,  70] },
            { key: '存货',             items: [80,  100, 120] },
            { key: '__流动资产合计',   isTotal: true, items: [460, 600, 770] },
            { key: '固定资产净值',     items: [350, 330, 310] },
            { key: '无形资产',         items: [20,  20,  20] },
            { key: '__资产总计',       isTotal: true, items: [830, 950, 1100] },
            { key: '短期借款',         items: [200, 250, 300] },
            { key: '应付账款',         items: [150, 200, 250] },
            { key: '应交税金',         items: [15,  20,  25] },
            { key: '其他应付款',       items: [25,  30,  35] },
            { key: '__流动负债合计',   isTotal: true, items: [390, 500, 610] },
            { key: '__负债合计',       isTotal: true, items: [450, 580, 710] },
            { key: '实收资本',         items: [800, 800, 800] },
            { key: '__所有者权益',     isTotal: true, items: [380, 370, 390] },
            { key: '__负债及权益合计', isTotal: true, items: [830, 950, 1100] },
          ],
        },
        revenueAnalysis: {
          periods: [
          ...
          rows: [
            { key: '主营业务收入', items: [380, 450, 520] },
            { key: '营业利润',     items: [-20, 10,  25] },
            { key: '净利润',       items: [-30, -5,  10] },
            { key: '销售净利率',   items: ['-7.9%', '-1.1%', '1.9%'] },
            { key: 'ROE',         items: ['-7.9%', '-1.4%', '2.6%'] },
            { key: '资产负债率',   items: ['54.2%', '61.1%', '64.5%'] },
            { key: '流动比率',     items: ['1.18',  '1.20',  '1.26'] },
            { key: '速动比率',     items: ['0.97',  '1.00',  '1.07'] },
          ],
        },
      },
      // 第 3 步现场考察（v1.7.40 补全）
      siteInspection: {
        situation: '现场考察时间：2026-07-05，地点：河南省洛阳市西工区凯旋路 88 号 + 关林批发市场。冷链车辆 8 台（5 吨级 5 台 / 8 吨级 3 台），固定员工 12 人。仓储合作方为洛阳明远冷链运输有限公司（关联企业），月均吞吐约 800 吨。',
        attachments: [
          { type: '现场考察报告', name: '现场考察报告-2026-07-05.pdf', time: '2026-07-05 17:30:00' },
        ],
      },
      // 第 4 步风险评估（v1.7.40 补全 - 驳回意见）
      riskAssessment: {
        complianceAnalysis: '公司近 12 个月存在 3 起诉讼，2 起已判决执行（履约失信），1 起在二审中，诉讼风险较高。',
        financialAnalysis: '财务表现疲弱：2024 Q4 净利润 -7.9% / 2025 Q1 净利润 -1.1% / 资产负债率 54-65% 远超行业合理区间（30-40%），偿债能力承压。',
        creditEvaluation: '公司在同业无授信记录，无失信被执行人记录（核心企业层面），但诉讼风险叠加财务压力，建议暂缓准入。',
        otherNotes: '注册资本 800 万元低于准入门槛（建议 ≥ 1000 万元）。',
        conclusion: 'reject',
        remark: '不通过主要原因：（1）注册资本 800 万低于门槛；（2）近 12 月 3 起诉讼且 2 起已执行；（3）资产负债率 60%+ 财务承压。',
      },
    },

    // ========== v1.7.38 新增 adm_007 办结状态（演示流程完成） ==========
    adm_007: {
      companyName: '青岛海盈国际冷链有限公司',
      creditCode: '91370200MAXXXXXXXX',
      shortName: '海盈冷链',
      shortNamePinyin: 'HYLL',
      established: '2017-03-25',
      nature: '有限责任公司（台港澳法人独资）',
      businessDeadline: '长期有效',
      registeredAddress: '山东省青岛市市南区香港中路 76 号',
      industry: '国际冷链',
      registeredCapital: '8000万元',
      inRenewal: false,
      contactPhone: '158 0000 9988',
      contactAddress: '山东省青岛市市南区香港中路 76 号',
      businessScope: '国际海运冷链运输；进口冻品仓储与分拨；冷链物流咨询。',
      legalName: '林志鸿',
      legalIdCard: '11000019800101XXXX',
      legalPhone: '158 0000 9988',
      legalIdValidFrom: '2018-05-10',
      legalIdValidTo: '2038-05-10',
      shareholders: [
        { name: '香港海盈国际物流集团', type: '现金', amount: 80000000, ratio: 100, date: '2017-03-25' },
      ],
      otherInfo: {
        history: '公司由香港海盈国际物流集团独资设立，2017 年取得国际货运代理资质，2019 年获海关 AEO 高级认证，2022 年通过 GMP+ 冷链运输国际认证。',
        relatedEnterprises: '关联企业：香港海盈国际物流集团（100% 母公司）；青岛海盈报关有限公司（联营）。',
      },
      attachments: [
        { type: '营业执照',                  required: true,  files: [{ name: '营业执照-2025年.pdf', time: '2025-03-15 14:12:33' }] },
        { type: '法人身份证复印件',          required: true,  files: [{ name: '林志鸿身份证.pdf', time: '2025-03-15 14:15:22' }] },
        { type: '最近一年财务报表',          required: false, files: [{ name: '2024年度财务报表.pdf', time: '2025-03-15 14:18:45' }, { name: '审计报告-毕马威.pdf', time: '2025-03-15 14:20:11' }] },
        { type: '完税证明',                  required: false, files: [{ name: '2024年完税证明.pdf', time: '2025-03-15 14:23:08' }] },
        { type: '三个月内1-2份业务购销合同复印件、发票复印件', required: false, files: [{ name: '新西兰银蕨合同.pdf', time: '2025-03-15 14:25:30' }, { name: '澳洲牛肉合同.pdf', time: '2025-03-15 14:27:15' }] },
        { type: '其他附件',                  required: false, files: [{ name: 'AEO高级认证证书.pdf', time: '2025-03-15 14:30:00' }, { name: 'GMP+认证.pdf', time: '2025-03-15 14:32:00' }] },
      ],
      legalRep: '林志鸿',
      registeredCap: '8000万元',
      applyDate: '2025-09-20',
      ...
      // 第 2 步：资质审核
      qualification: {
        lawsuitSituation: '公司及母公司近三年无重大诉讼记录，无失信被执行人记录，国际海运纠纷均通过仲裁解决。',
        businessModel: '主营国际海运冷链 + 进口冻品仓储分拨 + 冷链物流咨询。年进口冻品约 8 万吨，主要客户为盒马、麦德龙、山姆等大型商超。',
        fundSettlement: '主要采用信用证（L/C） + 银行电汇（T/T）结算，与汇丰银行、招商银行签订 1 年期授信合同，月均结算量约 300 万美元。',
        balanceSheet: {
          periods: [
            { label: '2024 Q4', start: '2024-10', end: '2024-12' },
            { label: '2025 Q1', start: '2025-01', end: '2025-03' },
          ...
          rows: [
            { key: '货币资金',         items: [2500, 3200, 3800] },
            { key: '应收账款',         items: [5200, 5800, 6500] },
            { key: '其他应收款',       items: [300,  350,  400] },
            { key: '预付账款',         items: [1200, 1500, 1800] },
            { key: '存货',             items: [6800, 7200, 7500] },
            { key: '__流动资产合计',   isTotal: true, items: [16000, 18050, 20000] },
            { key: '长期股权投资',     items: [1200, 1200, 1200] },
            { key: '固定资产净值',     items: [4500, 4400, 4300] },
            { key: '无形资产',         items: [400,  400,  400] },
            { key: '长期待摊费用',     items: [200,  180,  160] },
            { key: '__资产总计',       isTotal: true, items: [22300, 24230, 26060] },
            { key: '短期借款',         items: [1500, 1800, 2100] },
            { key: '应付票据',         items: [800,  1000, 1200] },
            { key: '应付账款',         items: [4500, 5000, 5500] },
            { key: '应交税金',         items: [500,  600,  700] },
            { key: '其他应付款',       items: [300,  350,  400] },
            { key: '__流动负债合计',   isTotal: true, items: [7600, 8750, 9900] },
            { key: '__负债合计',       isTotal: true, items: [8000, 9200, 10400] },
            { key: '实收资本',         items: [8000, 8000, 8000] },
            { key: '资本公积',         items: [500,  500,  500] },
            { key: '盈余公积',         items: [400,  450,  500] },
            { key: '未分配利润',       items: [5400, 6080, 6660] },
            { key: '__所有者权益',     isTotal: true, items: [14300, 15030, 15660] },
            { key: '__负债及权益合计', isTotal: true, items: [22300, 24230, 26060] },
          ],
        },
        revenueAnalysis: {
          periods: [
          ...
          rows: [
            { key: '主营业务收入', items: [28000, 32000, 36500] },
            { key: '营业利润',     items: [2800,  3300,  3800] },
            { key: '净利润',       items: [2240,  2640,  3040] },
            { key: '销售净利率',   items: ['8.00%', '8.25%', '8.33%'] },
            { key: 'ROE',         items: ['15.7%', '17.6%', '19.4%'] },
            { key: '资产负债率',   items: ['35.9%', '38.0%', '39.9%'] },
            { key: '流动比率',     items: ['2.11',  '2.06',  '2.02'] },
            { key: '速动比率',     items: ['1.21',  '1.24',  '1.26'] },
          ],
        },
      },
      // 第 3 步：现场考察
      siteInspection: {
        situation: '现场考察时间：2025-10-15，地点：山东省青岛市市南区香港中路 76 号 + 前湾港保税冷库。办公面积 500 平方米，固定员工 36 人（管理层 8 / 销售 6 / 关务 5 / 仓储 12 / 运输 5）。保税冷库 1.8 万平方米，分 4 个温区（冷冻 -18℃ / 冷藏 0-4℃ / 常温 / 深冷 -25℃），月均吞吐 8000 吨。海关 AEO 高级认证 + GMP+ 双认证，运营管理规范，信息化系统完善。',
        attachments: [
          { type: '现场考察报告',     name: '现场考察报告-2025-10-15.pdf', time: '2025-10-15 17:30:33' },
          { type: '保税冷库运营资质', name: '保税冷库运营资质.pdf',        time: '2025-10-15 17:35:11' },
          { type: '海关AEO认证',     name: 'AEO高级认证.pdf',              time: '2025-10-15 17:38:22' },
        ],
      },
      // 第 4 步：风险评估
      riskAssessment: {
        complianceAnalysis: '公司及母公司近三年无重大违法违规记录，海关 AEO 高级认证 + GMP+ 冷链国际认证；无失信被执行人记录，无重大税收违法记录，无重大行政处罚记录。',
        financialAnalysis: '近 3 季度财务表现稳健：营收季均增长 14-15%，净利润率稳定在 8% 以上，资产负债率 36-40%（国际冷链行业合理区间），流动比率 > 2.0 偿债能力良好，速动比率 > 1.2 短期流动性充足。',
        creditEvaluation: '客户在我行及同业信用记录良好（母公司在汇丰银行 5 年期授信），无不良贷款记录，无重大违约事件。建议给予 AA 信用评级。',
        otherNotes: '建议关注：（1）国际贸易摩擦 / 关税政策变化风险；（2）汇率波动对进口业务的影响；（3）冷链国际海运成本变化。',
        conclusion: 'pass',
        remark: '该企业资质优良（AEO + GMP+ 双认证），财务稳健，国际冷链业务规模行业领先，同意准入并给予较高授信额度。',
      },
      // 第 5 步：办结
      completion: {
        conclusion: '通过',
        completionTime: '2025-10-25 11:20:00',
        operator: '王芳（监管方风控经理）',
        creditRating: 'AA',
        suggestedLimit: '1亿元',
        nextSteps: '3 个工作日内通知客户签订授信协议；同步至融资管理模块开通融资申请权限；邀请参加公司季度客户答谢会。',
      },
    },

    // ========== v1.7.40 补全现场考察/风险评估/不通过示例 ==========
    // adm_008: 上海冰港国际物流 — 演示「卡在现场考察」
    adm_008: {
      companyName: '上海冰港国际物流有限公司',
      creditCode: '91310000MAXXXXXXXX',
      shortName: '冰港国际',
      shortNamePinyin: 'BGGJ',
      established: '2014-09-12',
      nature: '有限责任公司',
      businessDeadline: '至 2034-09-11',
      registeredAddress: '上海市浦东新区张江高科园区科苑路 88 号',
      industry: '国际冷链',
      registeredCapital: '5000万元',
      inRenewal: false,
      contactPhone: '138 0000 8801',
      contactAddress: '上海市浦东新区张江高科园区科苑路 88 号',
      businessScope: '国际冷链物流；冷库仓储；进口清关；冷链运输。',
      legalName: '王晓东',
      legalIdCard: '11000019780615XXXX',
      legalPhone: '138 0000 8801',
      legalIdValidFrom: '2019-04-12',
      legalIdValidTo: '2039-04-12',
      shareholders: [
        { name: '王晓东（自然人）',       type: '现金', amount: 35000000, ratio: 70, date: '2014-09-12' },
        { name: '上海冰盛投资合伙企业',  type: '股权出资', amount: 10000000, ratio: 20, date: '2016-05-20' },
        { name: '张伟（自然人）',         type: '现金', amount: 5000000,  ratio: 10, date: '2018-08-15' },
      ],
      otherInfo: {
        history: '公司由王晓东创立，专注国际冷链物流 10 年。2018 年获自贸区冷链保税仓资质，2020 年通过 ISO 22000 食品安全管理体系认证，2022 年获 AEO 高级认证。',
        relatedEnterprises: '关联企业：上海冰盛投资合伙企业（持股 20% 股东）；上海冷链技术研究院（合作单位）。',
      },
      attachments: [
        { type: '营业执照',                  required: true,  files: [{ name: '营业执照-2025年.pdf', time: '2025-08-12 09:15:33' }] },
        { type: '法人身份证复印件',          required: true,  files: [{ name: '王晓东身份证.pdf', time: '2025-08-12 09:18:22' }] },
        { type: '最近一年财务报表',          required: false, files: [{ name: '2024年度财务报表.pdf', time: '2025-08-12 09:20:45' }] },
        { type: '完税证明',                  required: false, files: [{ name: '2024年完税证明.pdf', time: '2025-08-12 09:23:08' }] },
        { type: '三个月内1-2份业务购销合同复印件、发票复印件', required: false, files: [{ name: '新西兰银蕨合同.pdf', time: '2025-08-12 09:25:30' }] },
        { type: '其他附件',                  required: false, files: [{ name: 'ISO22000.pdf', time: '2025-08-12 09:30:00' }, { name: 'AEO高级认证.pdf', time: '2025-08-12 09:32:00' }] },
      ],
      legalRep: '王晓东',
      registeredCap: '5000万元',
      applyDate: '2026-07-08',
      ...
      // 第 2 步：资质审核（已通过）
      qualification: {
        lawsuitSituation: '公司及实际控制人近三年无重大诉讼记录，2021 年 1 起仓库租赁合同纠纷已和解结案，无失信被执行人记录。',
        businessModel: '主营国际冷链物流（海运/空运）+ 进口清关 + 保税冷库仓储。客户主要为进口食品贸易商与跨境电商，年吞吐量约 1.5 万吨。',
        fundSettlement: '主要采用信用证（L/C）+ 银行电汇（T/T）结算，与汇丰银行、招商银行签订 1 年期授信合同，月均结算量约 200 万美元。',
        balanceSheet: {
          periods: [
            { label: '2024 Q4', start: '2024-10', end: '2024-12' },
            { label: '2025 Q1', start: '2025-01', end: '2025-03' },
          ...
          rows: [
            { key: '货币资金',         items: [1500, 1900, 2200] },
            { key: '应收账款',         items: [2800, 3200, 3500] },
            { key: '其他应收款',       items: [150,  180,  200] },
            { key: '预付账款',         items: [600,  700,  800] },
            { key: '存货',             items: [3500, 3800, 4000] },
            { key: '__流动资产合计',   isTotal: true, items: [8550, 9780, 10700] },
            { key: '长期股权投资',     items: [600,  600,  600] },
            { key: '固定资产净值',     items: [2800, 2700, 2600] },
            { key: '无形资产',         items: [200,  200,  200] },
            { key: '长期待摊费用',     items: [100,  90,   80] },
            { key: '__资产总计',       isTotal: true, items: [12250, 13370, 14180] },
            { key: '短期借款',         items: [800,  1000, 1100] },
            { key: '应付票据',         items: [400,  500,  600] },
            { key: '应付账款',         items: [2000, 2300, 2500] },
            { key: '应交税金',         items: [200,  250,  300] },
            { key: '其他应付款',       items: [150,  180,  200] },
            { key: '__流动负债合计',   isTotal: true, items: [3550, 4230, 4700] },
            { key: '__负债合计',       isTotal: true, items: [3850, 4550, 5050] },
            { key: '实收资本',         items: [5000, 5000, 5000] },
            { key: '资本公积',         items: [300,  300,  300] },
            { key: '盈余公积',         items: [250,  280,  310] },
            { key: '未分配利润',       items: [2850, 3240, 3520] },
            { key: '__所有者权益',     isTotal: true, items: [8400, 8820, 9130] },
            { key: '__负债及权益合计', isTotal: true, items: [12250, 13370, 14180] },
          ],
        },
        revenueAnalysis: {
          periods: [
          ...
          rows: [
            { key: '主营业务收入', items: [12000, 14500, 16800] },
            { key: '营业利润',     items: [1200,  1450,  1680] },
            { key: '净利润',       items: [960,   1160,  1340] },
            { key: '销售净利率',   items: ['8.0%', '8.0%', '8.0%'] },
            { key: 'ROE',         items: ['11.4%', '13.2%', '14.7%'] },
            { key: '资产负债率',   items: ['31.4%', '34.0%', '35.6%'] },
            { key: '流动比率',     items: ['2.41',  '2.31',  '2.28'] },
            { key: '速动比率',     items: ['1.42',  '1.41',  '1.43'] },
          ],
        },
      },
      // 第 3 步：现场考察（部分填，监管方正在现场）
      siteInspection: {
        situation: '现场考察时间：2026-07-15（进行中），地点：上海市浦东新区张江高科园区科苑路 88 号 + 外高桥保税冷库。\n\n截至当前监管方现场人员已查看：办公场地 500 平方米 ✓ / 保税冷库 8000 平方米（4 个温区）✓ / 冷链运输车队（30 台车）✓\n\n待完成：仓储管理信息系统 / 应急预案 / 员工培训档案。',
        attachments: [
          { type: '现场考察报告（草稿）', name: '现场考察报告-2026-07-15-草稿.pdf', time: '2026-07-15 14:30:00' },
        ],
      },
    },

    // adm_009: 浙江舟山远洋渔业 — 演示「卡在风险评估」
    adm_009: {
      companyName: '浙江舟山远洋渔业股份有限公司',
      creditCode: '91330900MAXXXXXXXX',
      shortName: '舟山远洋',
      shortNamePinyin: 'ZSYY',
      established: '2010-06-18',
      nature: '股份有限公司',
      businessDeadline: '长期有效',
      registeredAddress: '浙江省舟山市定海区临港工业区海富路 18 号',
      industry: '远洋渔业',
      registeredCapital: '1.2亿元',
      inRenewal: false,
      contactPhone: '139 0000 9999',
      contactAddress: '浙江省舟山市定海区临港工业区海富路 18 号',
      businessScope: '远洋捕捞；海产品冷链运输；进出口贸易；水产品加工。',
      legalName: '陈大海',
      legalIdCard: '11000019650822XXXX',
      legalPhone: '139 0000 9999',
      legalIdValidFrom: '2018-08-10',
      legalIdValidTo: '2038-08-10',
      shareholders: [
        { name: '陈大海（自然人）',           type: '现金', amount: 72000000, ratio: 60, date: '2010-06-18' },
        { name: '舟山海洋产业投资基金',       type: '现金', amount: 24000000, ratio: 20, date: '2010-08-15' },
        { name: '浙江海盛投资管理有限公司',   type: '现金', amount: 12000000, ratio: 10, date: '2015-03-20' },
        { name: '员工持股平台',               type: '现金', amount: 12000000, ratio: 10, date: '2018-12-01' },
      ],
      otherInfo: {
        history: '公司由陈大海创立，是舟山地区规模最大的远洋渔业企业之一。2014 年获农业部远洋渔业企业资格，2018 年通过 MSC 海洋管理委员会可持续渔业认证，2020 年新建 1 万吨级冷库。',
        relatedEnterprises: '关联企业：浙江海盛投资管理有限公司（持股 10% 股东）；舟山远洋水产加工有限公司（联营）。',
      },
      attachments: [
        { type: '营业执照',                  required: true,  files: [{ name: '营业执照-2025年.pdf', time: '2025-06-15 09:15:33' }] },
        { type: '法人身份证复印件',          required: true,  files: [{ name: '陈大海身份证.pdf', time: '2025-06-15 09:18:22' }] },
        { type: '最近一年财务报表',          required: false, files: [{ name: '2024年度财务报表.pdf', time: '2025-06-15 09:20:45' }, { name: '审计报告-普华永道.pdf', time: '2025-06-15 09:22:00' }] },
        { type: '完税证明',                  required: false, files: [{ name: '2024年完税证明.pdf', time: '2025-06-15 09:25:30' }] },
        { type: '三个月内1-2份业务购销合同复印件、发票复印件', required: false, files: [{ name: '日本三井合同.pdf', time: '2025-06-15 09:28:00' }, { name: '韩国LG合同.pdf', time: '2025-06-15 09:30:00' }] },
        { type: '其他附件',                  required: false, files: [{ name: '远洋渔业许可证.pdf', time: '2025-06-15 09:32:00' }, { name: 'MSC认证.pdf', time: '2025-06-15 09:35:00' }] },
      ],
      legalRep: '陈大海',
      registeredCap: '1.2亿元',
      applyDate: '2026-07-10',
      ...
      // 第 2 步：资质审核（已通过）
      qualification: {
        lawsuitSituation: '公司及实际控制人近三年无重大诉讼记录，2022 年 1 起国际货物运输合同纠纷经仲裁和解结案，无失信被执行人记录。',
        businessModel: '主营远洋捕捞（金枪鱼/鱿鱼/秋刀鱼）+ 海上冷链运输 + 陆上冷库仓储 + 进出口贸易。年捕捞量约 5 万吨，70% 出口日韩及东南亚。',
        fundSettlement: '主要采用美元信用证 + 离岸账户结算，与中国银行、汇丰银行舟山分行签订 1 年期授信合同，月均结算量约 500 万美元。',
        balanceSheet: {
          periods: [
            { label: '2024 Q4', start: '2024-10', end: '2024-12' },
            { label: '2025 Q1', start: '2025-01', end: '2025-03' },
          ...
          rows: [
            { key: '货币资金',         items: [3500, 4200, 4800] },
            { key: '应收账款',         items: [4800, 5400, 6000] },
            { key: '其他应收款',       items: [200,  250,  300] },
            { key: '预付账款',         items: [1500, 1800, 2100] },
            { key: '存货',             items: [8500, 9000, 9500] },
            { key: '__流动资产合计',   isTotal: true, items: [18500, 20650, 22700] },
            { key: '长期股权投资',     items: [1500, 1500, 1500] },
            { key: '固定资产净值',     items: [6500, 6300, 6100] },
            { key: '无形资产',         items: [500,  500,  500] },
            { key: '长期待摊费用',     items: [200,  180,  160] },
            { key: '__资产总计',       isTotal: true, items: [27200, 29130, 30960] },
            { key: '短期借款',         items: [2000, 2400, 2800] },
            { key: '应付票据',         items: [1000, 1200, 1400] },
            { key: '应付账款',         items: [4000, 4500, 5000] },
            { key: '应交税金',         items: [500,  600,  700] },
            { key: '其他应付款',       items: [300,  350,  400] },
            { key: '__流动负债合计',   isTotal: true, items: [7800, 9050, 10300] },
            { key: '__负债合计',       isTotal: true, items: [8200, 9500, 10800] },
            { key: '实收资本',         items: [12000, 12000, 12000] },
            { key: '资本公积',         items: [800,  800,  800] },
            { key: '盈余公积',         items: [600,  650,  700] },
            { key: '未分配利润',       items: [5600, 6180, 6660] },
            { key: '__所有者权益',     isTotal: true, items: [19000, 19630, 20160] },
            { key: '__负债及权益合计', isTotal: true, items: [27200, 29130, 30960] },
          ],
        },
        revenueAnalysis: {
          periods: [
          ...
          rows: [
            { key: '主营业务收入', items: [35000, 40000, 45000] },
            { key: '营业利润',     items: [3500,  4000,  4500] },
            { key: '净利润',       items: [2800,  3200,  3600] },
            { key: '销售净利率',   items: ['8.0%', '8.0%', '8.0%'] },
            { key: 'ROE',         items: ['14.7%', '16.3%', '17.9%'] },
            { key: '资产负债率',   items: ['30.1%', '32.6%', '34.9%'] },
            { key: '流动比率',     items: ['2.37',  '2.28',  '2.20'] },
            { key: '速动比率',     items: ['1.28',  '1.29',  '1.28'] },
          ],
        },
      },
      // 第 3 步：现场考察（已通过）
      siteInspection: {
        situation: '现场考察时间：2026-07-18，地点：浙江省舟山市定海区临港工业区海富路 18 号 + 沈家门渔港基地。\n\n考察内容：办公区 1000 平方米 / 万吨级冷库（4 个温区，含 -25℃ 深冷金枪鱼专用库）/ 远洋渔船队（12 艘远洋渔船，含 3 艘 1000 吨级大型金枪鱼延绳钓船）/ 渔港装卸码头 800 米。\n\n员工 320 人（船员 240 + 陆上 80），含高级船员 28 人。MSC 可持续渔业认证 + HACCP 食品安全认证，运营管理规范，远洋-陆上一体化冷链体系成熟。',
        attachments: [
          { type: '现场考察报告',     name: '现场考察报告-2026-07-18.pdf', time: '2026-07-18 16:30:00' },
          { type: '冷库运营资质',     name: '万吨级冷库运营资质.pdf',       time: '2026-07-18 16:35:00' },
          { type: '远洋渔业船队',     name: '远洋船队船舶证书.pdf',          time: '2026-07-18 16:40:00' },
        ],
      },
      // 第 4 步：风险评估（部分填，监管方正在评估）
      riskAssessment: {
        complianceAnalysis: '公司及实际控制人近三年无重大违法违规记录，MSC + HACCP + 远洋渔业许可三证齐全；无失信被执行人记录，无重大税收违法记录，无重大行政处罚记录。\n\n（监管方正在做：远洋捕捞配额合规性核查、进出口许可有效性核查 — 预计 2 个工作日内完成）',
        financialAnalysis: '近 3 季度财务表现稳健：营收季均增长 14-15%，净利润率稳定在 8% 左右，资产负债率 30-35%（远洋渔业行业合理区间），流动比率 > 2.2 偿债能力良好。\n\n（监管方正在做：2024 年渔船燃油套保损益 / 2025 年汇率敞口压力测试）',
        creditEvaluation: '',  // 监管方正在评估
        otherNotes: '',
        conclusion: '',  // 待定
        remark: '本笔风险评估由监管方风控经理王芳进行中，预计 2 个工作日内出具结论。',
      },
    },

    // adm_010 详情：武汉冷链速运 — 演示「风险评估驳回 + 失信被执行人」
    adm_010: {
      companyName: '武汉冷链速运有限公司',
      creditCode: '91420100MAXXXXXXXX',
      shortName: '武汉冷链',
      shortNamePinyin: 'WHLL',
      established: '2022-03-08',
      nature: '有限责任公司',
      businessDeadline: '至 2042-03-07',
      registeredAddress: '湖北省武汉市东西湖区临空港经济技术开发区五环大道 88 号',
      industry: '冷链运输',
      registeredCapital: '500万元',
      inRenewal: false,
      contactPhone: '139 0000 6655',
      contactAddress: '湖北省武汉市东西湖区临空港经济技术开发区五环大道 88 号',
      businessScope: '冷链运输；同城配送；冷库租赁。',
      legalName: '刘海涛',
      legalIdCard: '11000019881210XXXX',
      legalPhone: '139 0000 6655',
      legalIdValidFrom: '2020-01-15',
      legalIdValidTo: '2040-01-15',
      shareholders: [
        { name: '刘海涛（自然人）', type: '现金', amount: 3500000, ratio: 70, date: '2022-03-08' },
        { name: '李娟（自然人）',   type: '现金', amount: 1500000, ratio: 30, date: '2022-03-08' },
      ],
      otherInfo: {
        history: '公司由刘海涛与李娟共同出资设立，2022 年取得道路运输许可证，主要服务武汉地区餐饮连锁客户。',
        relatedEnterprises: '关联企业：武汉冰联冷链设备有限公司（同一控股股东刘海涛）。',
      },
      attachments: [
        { type: '营业执照',                  required: true,  files: [{ name: '营业执照.pdf', time: '2024-05-15 11:20:33' }] },
        { type: '法人身份证复印件',          required: true,  files: [{ name: '刘海涛身份证.pdf', time: '2024-05-15 11:22:15' }] },
        { type: '最近一年财务报表',          required: false, files: [{ name: '2024年财务报表.pdf', time: '2024-05-15 11:25:08' }] },
        { type: '完税证明',                  required: false, files: [] },
        { type: '三个月内1-2份业务购销合同复印件、发票复印件', required: false, files: [{ name: '武汉某连锁餐饮配送合同.pdf', time: '2024-05-15 11:30:00' }] },
        { type: '其他附件',                  required: false, files: [] },
      ],
      legalRep: '刘海涛',
      registeredCap: '500万元',
      ...
      // 资质审核
      qualification: {
        lawsuitSituation: '公司本身近 12 个月无诉讼记录，但实际控制人刘海涛近 3 年有 2 起失信被执行人记录（标的合计 35 万元，均已履行完毕）。',
        businessModel: '主营冷链运输（8 台冷链车），客户为武汉地区连锁餐饮。',
        fundSettlement: '现金 + 银行转账，无银行授信。',
        balanceSheet: null,
        revenueAnalysis: null,
      },
      // 现场考察（已完成）
      siteInspection: {
        situation: '现场考察时间：2026-06-25，地点：湖北省武汉市东西湖区。冷链车辆 8 台（5 吨级 5 台 / 8 吨级 3 台），固定员工 12 人。仓储合作方为武汉冰联冷链设备有限公司（关联企业），月均吞吐约 800 吨。',
        attachments: [
          { type: '现场考察报告', name: '现场考察报告-2026-06-25.pdf', time: '2026-06-25 17:30:00' },
        ],
      },
      // 风险评估驳回
      riskAssessment: {
        complianceAnalysis: '公司本身合规无问题，但**实际控制人刘海涛近 3 年有 2 起失信被执行人记录**（标的合计 35 万元，分别于 2023 年 8 月和 2024 年 3 月履行完毕）。',
        financialAnalysis: '注册资本 500 万元低于准入门槛（建议 ≥ 1000 万元）；财务报表数据未提供完整。',
        creditEvaluation: '实际控制人信用风险显著，2 起失信记录虽已履行但反映其历史履约能力不足。',
        otherNotes: '建议待实际控制人信用记录满 3 年干净期（2027-08 后）后重新申请。',
        conclusion: 'reject',
        remark: '不通过主要原因：（1）实际控制人有失信被执行记录；（2）注册资本 500 万低于 1000 万门槛。',
      },
    },
  },
  ...
  inboundList: [
    ...
    // ========== v1.7.55 新增：担保方【待担保确认】状态数据(3 条覆盖完整进度) ==========
    {
      ...
      vehicleNo: '豫A·P6628',
      driver: '孙建新',
      driverPhone: '137 0000 5566',
      products: [
        { id: 'MNG_SZNRQq_3191398', name: '蒙古水煮牛肉Qq', pieces: 470, weight: 9400, evaluatePrice: 78, evaluateValue: 733200 },
      ],
      totalValue: 733200,
      expectedLoan: 586560,
    ...
    },
    {
      ...
      vehicleNo: '豫A·Q7719',
      driver: '马向前',
      driverPhone: '136 0000 7788',
      products: [
        { id: 'AUTO_MULTI_002', name: '冷冻去骨牛7件套', pieces: 320, weight: 6000, evaluatePrice: 55.5, evaluateValue: 333000 },
      ],
      totalValue: 333000,
      expectedLoan: 266400,
      applyDate: '2026-07-12',
      inboundDate: '2026-07-14',
      status: 'pending_guarantor_seal',
      currentApprover: 'guarantor',
      drafter: '陈志强',
      sealUser: '李雪',
      sealCompleted: false,
      creator: '陈志强',
      creatorUserRole: 'operator',
      guarantorOpinion: '该笔入库货物冻品质量符合入库标准，担保方同意入库并承担连带保证责任。',
      guarantorReviewer: '担保方业务一部',
      guarantorReviewTime: '2026-07-13 11:20',
    },
    {
      id: 'in_009',
      bizNo: 'IN_20260710001',
      applicant: '郑州某冷链贸易有限公司',
      customerCode: 'JMY',
      guarantorId: 'u_guar_001',
      warehouse: '物流港二期大河智链监管库',
      vehicleNo: '豫A·R8830',
      driver: '杨春生',
      driverPhone: '135 0000 9900',
      products: [
        { id: 'MNG_SZSYR_BWS_004', name: '保乐肩-巴西-4490', pieces: 280, weight: 6000, evaluatePrice: 75, evaluateValue: 450000 },
      ],
      totalValue: 450000,
      expectedLoan: 360000,
      applyDate: '2026-07-10',
      inboundDate: '2026-07-12',
      status: 'reviewing',
      currentApprover: 'platform',
      drafter: '陈志强',
      sealUser: '李雪',
      ...
      creator: '陈志强',
      creatorUserRole: 'operator',
      guarantorOpinion: '该笔入库货物来源清晰、单据齐全，担保方同意入库并承担连带保证责任。建议监管方按货值 80% 评估融资额度。',
      guarantorReviewer: '担保方业务一部',
      guarantorReviewTime: '2026-07-11 14:35',
    },
    // ========== v1.7.56 新增：货主方【待提交】状态数据(3 条覆盖不同草稿阶段) ==========
    {
      id: 'in_010',
      bizNo: 'IN_20260714001',
      applicant: '郑州某冷链贸易有限公司',
      ...
      vehicleNo: '豫A·S1042',
      driver: '吴建业',
      driverPhone: '135 0000 4466',
      products: [
        { id: 'MNG_SZNRQq_3191399', name: '蒙古水煮牛肉Qq', pieces: 320, weight: 6400, evaluatePrice: 78, evaluateValue: 499200 },
      ],
      totalValue: 499200,
      expectedLoan: 399360,
      applyDate: '2026-07-14',
      inboundDate: '2026-07-16',
      status: 'draft',
      currentApprover: 'customer',
      drafter: '陈志强',
      sealUser: '李雪',
      sealCompleted: false,
      creator: '陈志强',
      ...
      pledgee: '中原再担保股份有限公司',
      remark: '待补充入库货物明细 3 个 SKU 的厂号/批号信息',
    },
    {
      id: 'in_011',
      bizNo: 'IN_20260714002',
      applicant: '郑州某冷链贸易有限公司',
      contactPerson: '李雪 — 138 0000 1234',
      customerCode: 'JMY',
      guarantorId: 'u_guar_001',
      ...
      vehicleNo: '豫A·T2253',
      driver: '徐国华',
      driverPhone: '139 0000 8877',
      products: [
        { id: 'MNG_QGNXG_002', name: '去骨牛心管', pieces: 580, weight: 11600, evaluatePrice: 74, evaluateValue: 858400 },
        { id: 'MNG_NJG_002', name: '牛颈骨', pieces: 220, weight: 4400, evaluatePrice: 24.5, evaluateValue: 107800 },
      ],
      totalValue: 966200,
      expectedLoan: 772960,
      applyDate: '2026-07-14',
      ...
      sealCompleted: false,
      creator: '陈志强',
      createdAt: '2026-07-14 11:30',
      creatorUserRole: 'operator',
      financeProduct: '中原e贷',
      supervisor: '大河智链物流（郑州）有限公司',
      pledgee: '中原再担保股份有限公司',
      remark: '随附《入境货物检验检疫证明》待上传',
    },
    {
      id: 'in_012',
      bizNo: 'IN_20260713002',
      applicant: '郑州某冷链贸易有限公司',
      contactPerson: '李雪 — 138 0000 1234',
      customerCode: 'JMY',
      guarantorId: 'u_guar_001',
      ...
      vehicleNo: '豫A·U3364',
      driver: '邹海洋',
      driverPhone: '136 0000 9955',
      products: [
        { id: 'MNG_GPYR_002', name: '羔羊肉', pieces: 480, weight: 9600, evaluatePrice: 56, evaluateValue: 537600 },
      ],
      totalValue: 537600,
      expectedLoan: 430080,
      applyDate: '2026-07-13',
      ...
      supervisor: '大河智链物流（郑州）有限公司',
      pledgee: '中原再担保股份有限公司',
      remark: '草稿阶段，已上传全部单据，待货主方审核后提交',
    },
    // ========== v1.7.57 新增：货主方提交后进入【待货主方盖章】状态数据(2 条) ==========
    // 入库申请 in_013/in_014：货主方 operator 已提交，等待盖章员李雪盖章
    {
      id: 'in_013',
      bizNo: 'IN_20260714003',
      applicant: '郑州某冷链贸易有限公司',
      contactPerson: '李雪 — 138 0000 1234',
      customerCode: 'JMY',
      guarantorId: 'u_guar_001',
      ...
      vehicleNo: '豫A·V4475',
      driver: '邓兆丰',
      driverPhone: '134 0000 6655',
      products: [
        { id: 'MNG_SZNRQq_3191400', name: '蒙古水煮牛肉Qq', pieces: 380, weight: 7600, evaluatePrice: 78, evaluateValue: 592800 },
      ],
      totalValue: 592800,
      expectedLoan: 474240,
      applyDate: '2026-07-14',
      ...
      submitTime: '2026-07-14 11:45',
      creatorUserRole: 'operator',
      financeProduct: '中原e贷',
      supervisor: '大河智链物流（郑州）有限公司',
      pledgee: '中原再担保股份有限公司',
      submitRemark: '已通过内部审批，请尽快盖章',
    },
    {
      id: 'in_014',
      bizNo: 'IN_20260713003',
      applicant: '郑州某冷链贸易有限公司',
      contactPerson: '李雪 — 138 0000 1234',
      customerCode: 'JMY',
      guarantorId: 'u_guar_001',
      ...
      vehicleNo: '豫A·W5586',
      driver: '黄启明',
      driverPhone: '133 0000 7766',
      products: [
        { id: 'MNG_QGNXG_003', name: '去骨牛心管', pieces: 420, weight: 8400, evaluatePrice: 74, evaluateValue: 621600 },
        { id: 'MNG_NJG_003', name: '牛颈骨', pieces: 180, weight: 3600, evaluatePrice: 24.5, evaluateValue: 88200 },
      ],
      totalValue: 709800,
      expectedLoan: 567840,
      applyDate: '2026-07-13',
