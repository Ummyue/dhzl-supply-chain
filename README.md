...
| 角色 | 一句话职责 | demo 账号 |
|---|---|---|
| **货主方 · 操作人** | 业务操作（创建申请、查看进度） | 陈志强（军牧源）|
| **货主方 · 盖章人** | 仅入库申请的电子签章 | 李雪（军牧源）|
...
| 角色 | 姓名 | 公司 | 部门 | 权限 |
|---|---|---|---|---|
| 货主方·操作人 | 陈志强 | 郑州军牧源贸易 | - | 无电子签章权（仅保存草稿）|
| 货主方·盖章人 | 李雪 | 郑州军牧源贸易 | 财务部 | 有盖章权（3 个印章）|
| 监管方 | 李雪 | 大河智链物流（郑州）| 风控运营部 | 准入/入库/融资/出库审批 |
